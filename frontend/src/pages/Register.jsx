  ...
  return (
    <div className="auth-container">
       ...
       <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[var(--secondary-color)] rounded-full mix-blend-screen filter blur-[150px] opacity-10" style={{ transform: 'translate(-50%, -50%)', filter: 'blur(150px)' }}></div>
      </div>

      <div className="glass-panel auth-box">
        <h2 className="text-3xl font-display font-bold text-center mb-8 tracking-wider" style={{ fontSize: '1.875rem', textAlign: 'center', marginBottom: '2rem', letterSpacing: '0.05em' }}>NEW IDENTITY</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="input-group">
            <label className="input-label" style={{ color: 'var(--secondary-color)' }}>Identity</label>
            <div className="relative">
              ...
              <input
                ...
                required
                style={{ focus: { borderColor: 'var(--secondary-color)' } }}
              />
            </div>
          </div>

          <div className="input-group">
            <label className="input-label" style={{ color: 'var(--secondary-color)' }}>Passcode</label>
            <div className="relative">
        ...
        <div className="mt-6 text-center text-sm text-gray-400" style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.875rem', color: '#9ca3af' }}>
          Already have an identity? <Link to="/login" className="text-[var(--secondary-color)] hover:underline" style={{ color: 'var(--secondary-color)' }}>Authenticate</Link>
        </div>
      </div>
    </div>
  );
